...
namespace WebAPI.Controllers
{
    ...
    public class ConsultasController : ControllerBase
    {
        ...
        [HttpGet("BuscarMedicoClinica")]
        public IActionResult BuscarMedicoClinica(Guid idMedico, Guid idClinica)
        {
            try
            {
                MedicosClinica medicoClinicaBuscada = consultaRepository.BuscaMedicoClinica(idMedico, idClinica);
                return Ok(medicoClinicaBuscada);
            }
            catch (Exception e)
            {
